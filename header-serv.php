...
<html lang="jp">
  ...
  <body>
    ...
    <header class="header-serv-sub">
      ...
      <!-- スマフォ以外のヘッダーナビゲーション -->
      <div class="header-nav-serv-sub">
        <span><a href="<?php echo home_url(); ?>/service">戻る</a></span>
      </div>

      <!-- スマフォ専用メニュー画面 -->
      <div class="hamburger-menu-serv-sub">

        <!-- ハンバーガーメニュー -->
        <figure class="menu-toggle-serv-sub">
          <img src="<?php echo get_template_directory_uri(); ?>/image/parts/hamburger-menu.png" alt="ハンバーガーメニュー" class="hamburger-bottun" />
        </figure>

        <!-- スマフォ用ナビゲーション画面 -->
        <div class="menu-serv-sub">

          <!-- 閉じるボタン -->
          <figure class="close-button-serv-sub">
          ...
          <div class="header-nav-sp">
            ...
            <nav>
              <ul>
                <li><a href="<?php echo home_url(); ?>/service">戻る</a></li>
              </ul>
            </nav>
          </div>
